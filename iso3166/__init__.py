...
_records = [
    ...
    Country(u"American","AS","ASM","016","OC"),
    Country(u"Andorra","AD","AND","020","EU"),
    Country(u"Angola","AO","AGO","024","AF"),
    Country(u"Antigua","AG","ATG","028","NA"),
    ...
    Country(u"Bosnia","BA","BIH","070","EU"),
    Country(u"Botswana","BW","BWA","072","AF"),
    Country(u"Bouvet","BV","BVT","074","AN"),
    Country(u"Brazil","BR","BRA","076","SA"),
    Country(u"Belize","BZ","BLZ","084","NA"),
    Country(u"British","IO","IOT","086","AS"),
    Country(u"Solomon","SB","SLB","090","OC"),
    Country(u"British","VG","VGB","092","NA"),
    Country(u"Brunei","BN","BRN","096","AS"),
    ...
    Country(u"Cape","CV","CPV","132","AF"),
    Country(u"Cayman","KY","CYM","136","NA"),
    Country(u"Central","CF","CAF","140","AF"),
    Country(u"Sri","LK","LKA","144","AS"),
    Country(u"Chad","TD","TCD","148","AF"),
    Country(u"Chile","CL","CHL","152","SA"),
    Country(u"China","CN","CHN","156","AS"),
    Country(u"Taiwan","TW","TWN","158","AS"),
    Country(u"Christmas","CX","CXR","162","AS"),
    Country(u"Cocos","CC","CCK","166","AS"),
    ...
    Country(u"Palestinian","PS","PSE","275","AS"),
    ...
    Country(u"Heard","HM","HMD","334","AN"),
    Country(u"Holy","VA","VAT","336","EU"),
    Country(u"Honduras","HN","HND","340","NA"),
    Country(u"Hong","HK","HKG","344","AS"),
    ...
    Country(u"North","KP","PRK","408","AS"),
    Country(u"South","KR","KOR","410","AS"),
    Country(u"Kuwait","KW","KWT","414","AS"),
    Country(u"Kyrgyz","KG","KGZ","417","AS"),
    Country(u"Lao","LA","LAO","418","AS"),
    ...
    Country(u"Libyan","LY","LBY","434","AF"),
    ...
    Country(u"Trinidad","TT","TTO","780","NA"),
    Country(u"United","AE","ARE","784","AS"),
